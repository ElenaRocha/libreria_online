...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference("Edition.count") do
      post editions_url, params: { edition: { book_id: @edition.book_id, isbn: @edition.isbn } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { book_id: @edition.book_id, isbn: @edition.isbn } }
